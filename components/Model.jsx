...
export function Model(props) {
  ...
  const options = useMemo(() => {
    return {
      x: { value: 0, min: -10, max: Math.PI * 2, step: 0.01 },
      y: { value: 0, min: -10, max: Math.PI * 2, step: 0.01 },
    ...
    <group {...props} dispose={null}>
      <group position={[0, 2, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <group
            position={[0.24, -1.092, -0.295]}
            rotation={[Math.PI / 2, 0, Math.PI]}
          >
            <mesh
              geometry={nodes.Cube003_black_0.geometry}
              material={nodes.Cube003_black_0.material}
              position={[-0.228, -0.179, -0.017]}
            >
              <meshBasicMaterial map={texture} />
            </mesh>
            <mesh
          ...
          <group
            position={[0.602, -0.739, -0.284]}
            rotation={[-Math.PI / 2, 0, -Math.PI]}
          >
            <group
              position={[-0.014, -0.029, 0.095]}
              rotation={[0.798, -0.409, -0.078]}
            >
              <mesh
          ...
          <group position={[0.108, -0.878, -0.687]} rotation={[0, 0.239, 0]}>
            <mesh
              geometry={nodes.Plane_leaves_0.geometry}
              material={nodes.Plane_leaves_0.material}
              position={[0.03, 0.118, -0.008]}
            >
              <meshBasicMaterial map={texture} />
            </mesh>
          </group>
          <group position={[1.065, -0.81, 0.075]} rotation={[0, 0, -Math.PI]}>
            <group position={[-0.051, 0.309, 0.002]} rotation={[0, -0.516, 0]}>
              <group
                position={[0.143, 0.202, 0.188]}
                rotation={[-Math.PI, 1.121, -Math.PI]}
              >
                <mesh
                  geometry={nodes.Circle002_black_0001.geometry}
                  material={nodes.Circle002_black_0001.material}
                  position={[-0.272, -1.541, -0.563]}
                >
                  <meshBasicMaterial map={texture} />
                </mesh>
              </group>
