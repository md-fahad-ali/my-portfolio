...
export function Model(props) {
  const { nodes, materials, animations } = useGLTF("/models/Rooms.glb");
  ...
  texture2.colorSpace = THREE.sRGBEncoding;
  ...
  return (
    ...
    >
      ...
      >
        <Html
          className="w-[380px] h-[212px] scale-[0.5] bg-black"
          style={{
        ...
        >
          <div
            className="w-[370px] h-[216px] -z-[9999]"
      ...
      >
        <Html
          className="w-[383px] h-[246px] bg-white rotate-360"
